...
class SearchBar {
    ...
    static function render(LabelService $labels): void {
        $placeholder = $labels->get('search_placeholder', __('Search…', 'appetitqr'));
        ?>
        <div class="apq-search">
            ...
            <input
                ...
                autocomplete="off"
            />
            <button type="button" class="apq-search-clear" data-apq-search-clear hidden aria-label="<?php esc_attr_e('Clear search', 'appetitqr'); ?>">
                &times;
            </button>
        </div>
        <?php
